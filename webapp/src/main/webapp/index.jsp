...
<nav class="navbar navbar-expand-lg bg-primary" data-bs-theme="dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="home">DevOps Training Code</a>
        ...
        <div class="collapse navbar-collapse" id="navbarColor01">
            <ul class="navbar-nav me-auto">
                <li class="nav-item">
                    <a class="nav-link active" href="students"><i class="fa-solid fa-list-check"></i>

                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="addStudent"><i class="fa-solid fa-user-plus"></i>
    ...
    <form>
        <fieldset>
            ...
            <div>
                ...
                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="First Name" autocomplete="off">
            </div>
            <div>
                <label for="exampleInputPassword1" class="form-label mt-4">Last Name</label>
                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Last Name" autocomplete="off">
            </div>

            <div>
                <label for="exampleInputPassword1" class="form-label mt-4">Email</label>
                <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Email" autocomplete="off">
            </div>
            <div>
